...
public:
    ...
    virtual int8_t getPacketDefinition(uint16_t index, uint8_t **packetDef) = 0;
    virtual uint8_t getArgumentCount(uint8_t *packetDef) = 0;
    virtual uint8_t *getFirstArgument(uint8_t *packetDef) = 0;
    virtual uint8_t *getNextArgument(uint8_t *argDef);
